...
int main() {
  ...
  player2.DrawRectangle(16, 23, 15, 16, 0, 0, 0);      // black background
                        //x y width height
  player2.DrawRectangle(26, 27, 5, 4, 102, 0, 0);      // right arm
  player2.DrawRectangle(15, 27, 6, 4, 102, 0, 0);      // left arm
  player2.DrawRectangle(12, 27, 3, 3, 255, 204, 204);  // left hand
  player2.DrawRectangle(31, 27, 3, 3, 255, 204, 204);  // right hand



  player2.DrawRectangle(17, 33, 4, 5, 102, 0, 0);      // left leg
  player2.DrawRectangle(27, 33, 4, 5, 102, 0, 0);      // right leg
  player2.DrawRectangle(17, 37, 4, 3, 64, 64, 64);     // left shoe
  player2.DrawRectangle(27, 37, 4, 3, 64, 64, 64);     // right shoe
  player2.SaveImageBmp("practice.bmp");
