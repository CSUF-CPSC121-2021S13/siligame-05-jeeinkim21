...
int main() {
  ...
  // details player2.DrawRectangle(37, 21, 3, 1, 64, 64, 64);      // grey sword
  ...
  // pupil player2.DrawRectangle(26, 14, 5, 4, 255, 255, 255);  // right eye
  // white player2.DrawRectangle(27, 15, 3, 2, 0, 0, 0);        // right eye
  // black pupil player2.DrawRectangle(12, 12, 6, 2, 0, 0, 0);        // left
  // eyebrow player2.DrawRectangle(16, 13, 5, 2, 0, 0, 0);        // r eyebrow
  ...
  // pProjectile.DrawRectangle(0, 0, 2, 1, 0, 0, 102);
  // pProjectile.DrawRectangle(0, 1, 3, 1, 0, 0, 102);
  // pProjectile.DrawRectangle(1, 2, 3, 1, 0, 0, 102);
  // pProjectile.DrawRectangle(2, 3, 6, 1, 0, 0, 102);
  // pProjectile.DrawRectangle(2, 4, 2, 1, 0, 0, 102);
  // pProjectile.DrawRectangle(3, 5, 1, 1, 0, 0, 102);
  // pProjectile.DrawRectangle(6, 4, 2, 1, 0, 0, 102);
  // pProjectile.DrawRectangle(6, 5, 1, 1, 0, 0, 102);
  // pProjectile.DrawRectangle(6, 2, 3, 1, 0, 0, 102);
  // pProjectile.DrawRectangle(7, 1, 3, 1, 0, 0, 102);
  // pProjectile.DrawRectangle(8, 0, 2, 1, 0, 0, 102);
  // pProjectile.DrawRectangle(2, 6, 6, 1, 0, 0, 102);
  // pProjectile.DrawRectangle(1, 7, 3, 1, 0, 0, 102);
  // pProjectile.DrawRectangle(6, 7, 3, 1, 0, 0, 102);
  // pProjectile.DrawRectangle(0, 8, 3, 1, 0, 0, 102);
  // pProjectile.DrawRectangle(7, 8, 3, 1, 0, 0, 102);
  // pProjectile.DrawRectangle(0, 9, 2, 1, 0, 0, 102);
  // pProjectile.DrawRectangle(8, 9, 2, 1, 0, 0, 102);
  ...
  // player1.DrawRectangle(16, 10, 15, 1, 160, 160, 160);  // grey headband
  // details player1.DrawRectangle(37, 21, 3, 1, 64, 64, 64);      // grey sword
  ...
  // player1.DrawRectangle(16, 14, 5, 4, 255, 255, 255);  // left eye white
  // player1.DrawRectangle(17, 15, 3, 2, 0, 0, 0);        // left eye black
  // pupil player1.DrawRectangle(26, 14, 5, 4, 255, 255, 255);  // right eye
  // white player1.DrawRectangle(27, 15, 3, 2, 0, 0, 0);        // right eye
  // black pupil player1.DrawRectangle(12, 12, 6, 2, 0, 0, 0);        // left
  // eyebrow player1.DrawRectangle(16, 13, 5, 2, 0, 0, 0);        // r eyebrow
